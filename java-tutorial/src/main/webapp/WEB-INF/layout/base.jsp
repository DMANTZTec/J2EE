				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<c:if test="${userConnected eq true}">
							...
							<li class="${current == 'createevents' ? 'active' : '' }">
								<a href="<spring:url value="/createevents.html" />">Create Event</a>
							</li>
							<li class="${current == 'uploadview' ? 'active' : '' }">
								<a href="<spring:url value="/uploadview.html" />">UploadFiles</a>
							</li>
